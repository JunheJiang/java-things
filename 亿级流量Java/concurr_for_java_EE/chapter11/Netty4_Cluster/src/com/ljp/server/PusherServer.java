...
public class PusherServer implements Runnable {
    ...
    private int port;
    private static Logger logger = Logger.getLogger(PusherServer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(true) {//实际项目中，会以kafka-receiver来替代该段代码。
            ...
            try {
                ...
                tmpObject = objIn.readObject();
                objIn.close();
                logger.info("kafka read object success!");
            } catch (IOException e) {
                logger.info("kafka read object: no object.");
            }
            
            if(tmpObject != null) {
            	SocketModel socketModel =  (SocketModel)tmpObject;
